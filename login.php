  ...
  $result = mysqli_query($conn,$sql);
    ...
    if($rows==1){   
     ...
     alert("Logged in successfully!"); 
        ...
        echo "<script>location.href='homedup.php'</script>";
...
<div class="icon-bar">
  ...
  <a href="#" class="youtube"><i class="fa fa-youtube"></i></a>
      ...
      <div class="textbox">
        ...
        <input type="text" placeholder="Username" name="login_name" value="">
      </div>

      <div class="textbox">

        <input type="password" placeholder="Password" name="login_pass" value="">

      </div>

      <input class="btn" type="submit" name="login_submit" value="Sign In">
      <input class="btn" type="submit" name="" value="Forgot Password?" href="forgotpwd.php">
